# JSBASH + AWS S3 with Node.JS

A simple and fully working example of JSBASH and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @JSBASH-example/aws-nodejs start
```
